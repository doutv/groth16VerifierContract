...
contract DeployAndVerifyProofScript is Script {
    ...
    function setUp() public {
        proof = [
            uint256(
                0x068466E96FE3E43A47A45A219D48EBFFC731102FBF921BB681D929F8CCD7DCCD
            ),
            uint256(
                0x18CA295C5AA34118E0D51A10514B1FEBDDD32C5655296B434AA8731A324081EA
            ),
            uint256(
                0x124C3E2CBC52722EE1827E22B984BEC788D57BED83D02FB45E88A5F8DF402FC9
            ),
            uint256(
                0x224878AB963945288E9EC5305622E6E9E4DDA3B8B859D0630B6095D6D67755DA
            ),
            uint256(
                0x1AC0CC9A2C98ECB5DEDE94825D0FF08B8767E9B5FE13C843D16F423A18586484
            ),
            uint256(
                0x14FF00434FB50F3716B5F2011C341175EEF7C0E8E478E9FAC850D10E63E97DB9
            ),
            uint256(
                0x01F608E7E6620BDED6A2472EC329D0AFFE52ECD5E4AF62299476EEF15DD769B4
            ),
            uint256(
                0x23E4C88D2AC7F2062AA77082A4BD9967A69590BF61A0AB657EA02EA35A10A97B
            )
        ];
        commitments = [
            uint256(
                0x032AFC4FA24014E503D42052A52FF814628C7EE24CF555F1C08F09B365F98D42
            ),
            uint256(
                0x157A2732C40ABA0A752BA9B09C236B146F8166763DC6E596C021EDE0650B034A
            )
        ];
        commitmentPok = [
            uint256(
                0x2D73A3AE1E7D1365AE44C36204FB9280DEDCC250DB8D4F24858A8969ED542B1D
            ),
            uint256(
                0x228F0592B8F77F4D8AD72FF574AF1B6E1AFDCAD2324CBBF1280D45A60A22226D
            )
        ];
        pubkeyX = [
    ...
    function verifyProof(address verifierAddr) internal {
        ...
        try
            verifier.callVerify10Signatures(
                proof,
                commitments,
                commitmentPok,
                pubkeyX,
